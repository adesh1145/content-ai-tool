...
from app.features.email_writer.adapter.inbound.web.dto.request import GenerateEmailRequest
from app.features.email_writer.adapter.inbound.web.dto.response import GenerateEmailResponse
