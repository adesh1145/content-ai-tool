...
from app.features.script_writer.adapter.inbound.web.dto.request import ScriptGenerateRequest
from app.features.script_writer.adapter.inbound.web.dto.response import ScriptGenerateResponse
