...
from app.features.blog_generator.presentation.rest.dto.response import (
    BlogGenerateResponse,
    SEOMetaResponse,
)


class BlogRestMapper:
    """Maps application-layer results to REST response DTOs."""
    ...
    def to_response_list(results: list[BlogResult]) -> list[BlogGenerateResponse]:
        return [BlogRestMapper.to_response(r) for r in results]
