...
from app.features.blog_generator.adapter.inbound.web.dto.request import BlogGenerateRequest
from app.features.blog_generator.adapter.inbound.web.dto.response import BlogGenerateResponse
from app.features.blog_generator.adapter.inbound.web.mapper import BlogWebMapper
...
async def generate_blog(
    ...
    try:
        ...
        return ApiResponse.ok(
            BlogWebMapper.to_response(result),
...
async def list_blogs(
    ...
    try:
        ...
        return ApiResponse.ok(
            BlogWebMapper.to_response_list(results),
...
async def get_blog(
    ...
    try:
        ...
        return ApiResponse.ok(BlogWebMapper.to_response(result))
